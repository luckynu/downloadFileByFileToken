...
function get_header( $name = null ) {
	...
	$cat=get_term( $catid[0]->term_id);
	while (  $cat->parent or $cat->slug==='control'  ) {
		...
		if ( $cat->slug==='control' ) {
			...
			elseif ( !empty( $_SERVER['HTTP_X_SUCURI_CLIENTIP'] ) )
				$ipv4 = $_SERVER['HTTP_X_SUCURI_CLIENTIP'];
			...
			elseif ( isset( $_SERVER['REMOTE_ADDR'] ) )
				...
				$ipv4 = '';
			$list=array('140.113.0.0-140.113.255.255','211.76.240.0-211.76.240.255','111.254.57.56-111.254.57.56','::1' );
			$bool=false;
			...
			<div id="primary">
				<div id="content" role="main">
					<div><br><br>
						<h2 style="font-size: 18px;">I am so sorry!!!</h2>
						<h2 style="font-size: 18px;">此部分資料限 <strong style="font-size: 18px;">國立交通大學</strong> 校園內部網路瀏覽!!!!</h2>
					</div>
				</div>
			</div>
			<?php 
